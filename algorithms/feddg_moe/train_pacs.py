...
def get_argparse():
    ...
    parser.add_argument('--num_classes', help='number of classes default 65', type=int, default=7)
...
def main():
    ...
    dataobj = PACS_FedDG(test_domain=args.test_domain, batch_size=args.batch_size, test_batch_size=args.test_batch_size)
