...
class OfficeHome_SingleDomain():
    def __init__(self, root_path=officehome_path, domain_name='p', split='train', train_transform=None, seed=0):
        ...
        self.txt_path = os.path.join(root_path, '{}_label.txt'.format(self.domain))
...
class OfficeHome_FedDG():
    def __init__(self, test_domain='p', batch_size=16, test_batch_size=8, seed=0):
        ...
        for domain_name in self.domain_list:
            self.site_dataloader_dict[domain_name], self.site_dataset_dict[domain_name] = OfficeHome_FedDG.SingleSite(
                domain_name, 
                self.batch_size, 
    ...
    @staticmethod
    def SingleSite(domain_name, batch_size=16, test_batch_size=8, seed=0):
        dataset_dict = {
